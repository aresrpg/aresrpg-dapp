...
.character(:class="{ locked: props.locked, [props.character.classe]: true, male: props.character.sex === 'male' }")
  ...
  .perso()
    characterCanvasDisplay(:character="props.character" :type="props.character.classe.toUpperCase() + '_' + props.character.sex.toUpperCase()" :colors="[props.character.color_1, props.character.color_2, props.character.color_3]")
  .field
    .title classe:
