...
const Auth = {
  microsoft: auth_code =>
    fetch('https://login.live.com/oauth20_token.srf', {
      ...
      body: `client_id=${VITE_AZURE_CLIENT}&client_secret=${MICROSOFT_CLIENT_SECRET}&code=${auth_code}&grant_type=authorization_code&redirect_uri=${VITE_MICROSOFT_REDIRECT_URI}`,
    })
