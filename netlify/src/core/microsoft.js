...
const Auth = {
  microsoft: auth_code =>
    fetch('https://login.live.com/oauth20_token.srf', {
      ...
      body: `client_id=${MICROSOFT_CLIENT_ID}&client_secret=${MICROSOFT_CLIENT_SECRET}&code=${auth_code}&grant_type=authorization_code&redirect_uri=${MICROSOFT_REDIRECT_URI}`,
    })
